...
Let me consider patterns $\mathbf{\xi}^1$, $\vec{\xi^2}$, $\ldots$, $\mathbf{\xi^M}$, are $N$-dimensional prototype patterns. Then we can easily memorize them inside the synaptic weights ${w_{ij}}$ by using **Hebb's learning rule**
